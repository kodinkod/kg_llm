...
@hydra.main(version_base=None, config_path="../configs/", config_name="base_rag_test.yaml")
def my_app(cfg: DictConfig) -> None:
    ...
    test_dataset['answer'] = test_dataset['question'].apply(lambda x: BASERAG(x.strip()))
