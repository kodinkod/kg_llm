...
from src.docx2graph.from_docx_structure.utils import  get_triples_from_dcx, get_GraphDocument_from_triples
...
doc_path="/Applications/programming/kg_llm/assets/dozor/usage_big.docx"
parser = DOCXParser()
...
graph = Neo4jGraph(database='handledocx2graph')
